  ...
  <div class="login-box">
    <div class="login-logo ">
      <a href="<?php echo base_url(); ?>">
        <b>
          <!-- <h3 style="font-weight: bold ; color:white;">- Hotline SMARTRI -</h3> -->
        </b></a>
    </div>
    ...
    <div class="card">
      <div class="card-header" style="background-color: #0d72a1; color:white">
        <h5><i class="fas fa-sign-in-alt"></i> Sign in to start your session</h5>
      </div>
      <div class="card-body login-card-body">
        <form action="" role="form" id="quickForm" method="post">
          ...
          <!-- /.col -->
          <div class="center">
            <button type="button" id="login" class="btn btn-info btn-block btn-flat" style="background-color: #0d72a1; color:white"><span class="fa fa-sign-in-alt"></span> Sign In</button>
          </div>
          <!-- /.col -->
          <!-- </div> -->
        </form>
      ...
      <div class="card-footer" style="text-align: center;">
        <b>
          ...
          echo 'Copyright &copy; ' . $aplikasi->tahun . ' | ' . $aplikasi->nama_owner;
          // }
