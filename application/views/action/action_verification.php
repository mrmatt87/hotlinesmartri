...
<?php
echo form_open_multipart('action/verification_save', 'role="form" class="form-horizontal"');
?>
<!-- Main content -->
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-row2 ">
            ...
            <div class="col-sm-8 ">
              <select class="form-control" name="verification_status" required>
                ...
                <option value="Not Conformed">Not Conformed</option>
                <option value="Conformed with remarks">Conformed with remarks</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-row2 ">
            ...
            <div class="col-sm-8 ">
            <input type="text" class="form-control" name="verification_emdate" value="<?php echo date('Y-m-d') ?>" readonly required>
          ...
          <!-- <div class="form-row2 ">
            ...
            <div class="col-sm-8 ">
              <textarea class="form-control" name="ref_number"    required> </textarea>
            </div>
          </div>
