...
<?php
echo form_open_multipart('action/verificationsmartri_save', 'role="form" class="form-horizontal"');
?>
<!-- Main content -->
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-row2 ">
            ...
            <div class="col-sm-8 ">
              <textarea class="form-control" name="verificationsmartri_remark"  required> </textarea>
            </div>
          </div>
          ...
          <div class="form-row2 ">
            ...
            <div class="col-sm-8 ">
            <input type="text" class="form-control" name="verification_smartridate" value="<?php echo date('Y-m-d') ?>" readonly required>
            </div>
          </div>
