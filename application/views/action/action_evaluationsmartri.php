...
<?php
echo form_open_multipart('action/evaluationsmartri_save', 'role="form" class="form-horizontal"');
?>
<!-- Main content -->
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-row2 ">
            ...
            <div class="col-sm-8 ">
              <textarea class="form-control"   readonly><?php echo $data['evaluation_feedbackestatecomments'] ?> </textarea>
            </div>
          </div>
          <div class="form-row2 ">
            <label class="col-sm-4 col-form-label">Date </label>
          ...
          <div class="form-row2 ">
            ...
            <div class="col-sm-8 ">
              <textarea class="form-control" name="evaluation_feedbacksmartri" required> </textarea>
            </div>
          </div>
