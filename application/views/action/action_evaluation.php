...
<?php
echo form_open_multipart('action/evaluation_save', 'role="form" class="form-horizontal"');
?>
<!-- Main content -->
      ...
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-row2 ">
            ...
            <div class="col-sm-8 ">
              <select class="form-control" name="evaluation_realization" required>
          ...
          <div class="form-row2 ">
            ...
            <div class="col-sm-8 ">
              <textarea class="form-control" name="evaluation_feedbackestatecomments" required> </textarea>
            </div>
          </div>
          <div class="form-row2 ">
            <label class="col-sm-4 col-form-label">Date </label>
            <div class="col-sm-2 ">
              <input type="text" class="form-control"  name="evaluation_date" value="<?php echo date("Y-m-d") ?>" readonly required>
            </div>
          </div>
