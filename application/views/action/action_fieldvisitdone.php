<head>
<title>Hotline SMARTRI | Field Visitdone</title>
...
<?php
    echo form_open_multipart('action/fieldvisitdone_save', 'role="form" class="form-horizontal"');
    ?>
    ...
    <div class="form-group col-sm-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          <div class="form-row2 ">
            <label class="col-sm-4 col-form-label">Response (PIC) done by</label>
            <div class="col-sm-8 ">
              <select id="section" name="responsedoneby_pic" class="form-control select2">
          ...
          <div class="form-row2 ">
            ...
            <div class="col-sm-8 ">
              <select id="pic" name="fieldvisitdone_pic" class="form-control select2">
          ...
          <div class="form-row2 ">
            ...
            <div class="col-sm-8 ">
              <select id="section2" name="fieldvisitdone_by" class="form-control select2">
                <option value="" >Select Section</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-row2 ">
            <label class="col-sm-4 col-form-label">Name of staff</label>
            <div class="col-sm-8 ">
              <select id="pic2" name="fieldvisitdone_staff" class="form-control select2">
                <option value=""  >Select PIC</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-row2 ">
            ...
            <div class="col-sm-8 ">
              <select id="section2" name="recomendation_by" class="form-control select2">
                <option value="" >Select Section</option>
              </select>
            </div>
          </div>
          ...
          <div class="form-row2 ">
            <label class="col-sm-4 col-form-label">Name of staff</label>
            <div class="col-sm-8 ">
              <select id="pic3" name="recomendation_staff" class="form-control select2">
                <option value="">Select PIC</option>
              </select>
            </div>
          </div>
